...
?>
    ...
    <section class="home__portfolio container" id="home__portfolio">
        <div class="pad-40">
            <div class="">
                <nav class="d-block">
                    <ul class="controls portfolio__list portfolio_control">
						<?php
                ...
                <div class="row portfolio__items galery_container">
					<?php
					$args = array(
						'numberposts'      => 0,
    ...
    <script>
        jQuery(document).ready(function ($) {
            // микситап
            $(function () {
                let containerEl = document.querySelector('.galery_container');
